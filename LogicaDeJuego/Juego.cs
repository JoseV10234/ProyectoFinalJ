...
namespace LogicaDeJuego
{
    public class Juego
    {
        ...
        public Juego()
        {
           ...
           // bancoDePreguntas[3] = new Dificultad(); A;ADIR UNA VEZ COMPLETOS
        ...
        public void CargarDatos()
        {
            ...
            bancoDePreguntas[3].preguntas[1].respuestasDeLaPregunta[2].EnunciadoDeLaRespuesta = "48";
            ...
            bancoDePreguntas[3].preguntas[6].respuestaCorrecta = 1;
            bancoDePreguntas[3].preguntas[6].respuestasDeLaPregunta[0].EnunciadoDeLaRespuesta = "12";
            bancoDePreguntas[3].preguntas[6].respuestasDeLaPregunta[1].EnunciadoDeLaRespuesta = "35";
            ...
            bancoDePreguntas[3].preguntas[10].respuestaCorrecta = 0;
            bancoDePreguntas[3].preguntas[10].respuestasDeLaPregunta[0].EnunciadoDeLaRespuesta = "1/8";
            ...
            bancoDePreguntas[4].preguntas[11].enunciadoDeLaPregunta = "El mínimo común múltiplo de 5 y 7 es";
            bancoDePreguntas[4].preguntas[11].respuestaCorrecta = 1;
            bancoDePreguntas[4].preguntas[11].respuestasDeLaPregunta[0].EnunciadoDeLaRespuesta = "12";
            bancoDePreguntas[4].preguntas[11].respuestasDeLaPregunta[1].EnunciadoDeLaRespuesta = "35";
            bancoDePreguntas[4].preguntas[11].respuestasDeLaPregunta[2].EnunciadoDeLaRespuesta = "5";
            */
        }
